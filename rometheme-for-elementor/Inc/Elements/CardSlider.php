...
class CardSlider extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('cardslider');
    }
    ...
    {
        return ['rtmkit-element-card_slider', 'rtmkit-lib-swiper.min'];
    }

    public function get_script_depends()
    {
        return ['rtmkit-element-card_slider', 'rtmkit-lib-swiper-bundle.min'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .rkit-card .card-body , {{WRAPPER}} .rkit-card .card-body::before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'select_style' => 'default'
                ]
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Text_Stroke::get_type(),
            [
                'name' => 'subheading_text_stroke_normal',
                'selector' => '{{WRAPPER}} .rkit-card .card-subheading',
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Text_Shadow::get_type(),
            [
                'name' => 'subheading_text_shadow_normal',
                'selector' => '{{WRAPPER}} .rkit-card .card-subheading',
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Text_Stroke::get_type(),
            [
                'name' => 'description_text_stroke_normal',
                'selector' => '{{WRAPPER}} .rkit-card .card-description',
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Text_Shadow::get_type(),
            [
                'name' => 'description_text_shadow_normal',
                'selector' => '{{WRAPPER}} .rkit-card .card-description',
            ]
        );
        ...
        $this->add_control('title_color_hover', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rkit-card:hover .card-title a' => 'color:{{VALUE}}'
            ]
        ]);
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rkit-card:hover .card-title a',
            ]
        );
        ...
        $this->add_control('card_subtitle_color_hover', [
            'label' => esc_html('Color'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rkit-card:hover .card-subheading' => 'color: {{VALUE}}'
            ]
        ]);
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Text_Stroke::get_type(),
            [
                'name' => 'subheading_text_stroke_hover',
                'selector' => '{{WRAPPER}} .rkit-card:hover .card-subheading',
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Text_Shadow::get_type(),
            [
                'name' => 'subheading_text_shadow_hover',
                'selector' => '{{WRAPPER}} .rkit-card:hover .card-subheading',
            ]
        );

        $this->add_control(
            'card_description_options_hover',
            [
                'label' => esc_html__('Description', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_control('description_color_hover', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rkit-card:hover .card-description' => 'color:{{VALUE}}'
            ]
        ]);
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Text_Stroke::get_type(),
            [
                'name' => 'description_text_stroke_hover',
                'selector' => '{{WRAPPER}} .rkit-card:hover .card-description',
            ]
        );
                            ...
                            <div class="rkit-card <?php echo esc_attr($settings['select_style']) ?>">
                                ...
                                <div class="card-body">
                                    <div class="card-heading">
                                        <?php if ($settings['subheading_position'] == 'top' && $settings['show_subheading'] == 'yes') : ?>
                                        ...
                                        <?php if ($settings['subheading_position'] == 'bottom' && $settings['show_subheading'] == 'yes') : ?>
                                            <span class="card-subheading"><?php echo esc_html($li['card_sub_title']) ?></span>
                                        <?php endif; ?>
                                    </div>
