...
class PostBlock extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('rkitpostblock');
    }
    ...
    {
        return ['rtmkit-element-post-block'];
    }
                ...
                <div class="rkit-post-block-card <?php echo esc_attr($hoverAnimation) ?>">
                    <?php if ('yes' === $settings['show-featured-image']) : ?>
                        <div class="rkit-image-container">
                            ...
                            ?>
                            <a class="rkit-image-link" style="overflow: hidden;" href="<?php the_permalink() ?>">
