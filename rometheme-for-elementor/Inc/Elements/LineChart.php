...
class LineChart extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('linechart');
    }
    ...
    {
        return ['rtmkit-element-line_chart', 'rtmkit-lib-chart.min'];
    }

    public function get_style_depends()
    {
        return ['rtmkit-element-linechart'];
    }
    ...
    protected function render()
    {
        ...
        $datasets = [
            ...
            'data' => $value,
            'pointBackgroundColor' => $this->get_color_code($settings, 'line_bg_normal'),
            'borderColor' => $this->get_color_code($settings, 'line_border_normal'),
            'borderWidth' => !empty($settings['border_width_normal']['size']) ? $settings['border_width_normal']['size'] : 1,
            'hoverBackgroundColor' => $this->get_color_code($settings, 'line_bg_hover'),
            'hoverBorderColor' => $this->get_color_code($settings, 'line_border_hover'),
            ...
            'backgroundColor' => $this->get_color_code($settings, 'fill_bg_color'),
            'showLine' => true
        ];
        ...
        $scales = [
            'x' => [
                ...
                'ticks' => [
                    'color' => $this->get_color_code($settings, 'scale_x_color'),
                    'font' => [
                ...
                'grid' => [
                    ...
                    'color' => $this->get_color_code($settings, 'grid_x_color'),
                ],
            ],
            'y' => [
                'beginAtZero' => true,
                ...
                'ticks' => [
                    'color' => $this->get_color_code($settings, 'scale_y_color'),
                    'font' => [
                ...
                'grid' => [
                    ...
                    'color' => $this->get_color_code($settings, 'grid_y_color'),
                ],
            ],
        ];
