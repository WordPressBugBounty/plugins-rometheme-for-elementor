...
class TestimonialCarousel extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('testimonialcarousel');
    }
    ...
    {
        return ['rtmkit-element-testimonial_carousel', 'rtmkit-lib-swiper-bundle.min'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}.edge-fade-enabled .rkit-testimonial-carousel .testimonial-container' => '--depth: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'show_edge_fade' => 'enabled'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .testimonial_header' => 'align-items: {{VALUE}};',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rkit-testimonial-navigation' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rkit-testimonial-navigation' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
