...
class NestedElementExample extends Widget_Nested_Base
{
	...
	{
		return esc_html__('RTM Test Nested Tabs', 'rometheme-for-elementor');
	}
	...
	protected function tab_content_container(int $index)
	{
		return [
			...
			'settings' => [
				'_title' => sprintf(
					/* translators: content*/
					__('Tab #%s', 'rometheme-for-elementor'),
					$index
				),
				'content_width' => 'full',
			],
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section('section_tabs', [
			'label' => esc_html__('Tabs', 'rometheme-for-elementor'),
		]);
		...
		$repeater->add_control('tab_title', [
			...
			'default' => esc_html__('Tab Title', 'rometheme-for-elementor'),
			'placeholder' => esc_html__('Tab Title', 'rometheme-for-elementor'),
			'label_block' => true,
			'dynamic' => [
				'active' => true,
			],
		...
		$repeater->add_control(
			'tab_icon_active',
			[
				'label' => esc_html__('Active Icon', 'rometheme-for-elementor'),
				'type' => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'skin' => 'inline',
				'label_block' => false,
		...
		$repeater->add_control(
			'element_id',
			[
				'label' => esc_html__('CSS ID', 'rometheme-for-elementor'),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'ai' => [
					'active' => false,
				...
				'title' => esc_html__('Add your custom id WITHOUT the Pound key. e.g: my-id', 'rometheme-for-elementor'),
		...
		$this->add_control('tabs', [
			'label' => esc_html__('Tabs Items', 'rometheme-for-elementor'),
			'type' => Control_Nested_Repeater::CONTROL_TYPE,
			'fields' => $repeater->get_controls(),
			'default' => [
				[
					'tab_title' => esc_html__('Tab #1', 'rometheme-for-elementor'),
				],
				[
					'tab_title' => esc_html__('Tab #2', 'rometheme-for-elementor'),
				],
				[
					'tab_title' => esc_html__('Tab #3', 'rometheme-for-elementor'),
				],
			],
			'title_field' => '{{{ tab_title }}}',
			'button_text' => esc_html__('Add Tab', 'rometheme-for-elementor'),
		]);
		...
		$this->add_responsive_control('tabs_direction', [
			...
			'options' => [
				'block-start' => [
					'title' => esc_html__('Above', 'rometheme-for-elementor'),
					'icon' => 'eicon-v-align-top',
				],
				'block-end' => [
					'title' => esc_html__('Below', 'rometheme-for-elementor'),
					'icon' => 'eicon-v-align-bottom',
				],
				'inline-end' => [
					'title' => esc_html__('After', 'rometheme-for-elementor'),
					'icon' => 'eicon-h-align-' . $end,
				],
				'inline-start' => [
					'title' => esc_html__('Before', 'rometheme-for-elementor'),
		...
		$this->add_responsive_control('tabs_justify_horizontal', [
			'label' => esc_html__('Justify', 'rometheme-for-elementor'),
			'type' => Controls_Manager::CHOOSE,
			'options' => [
				'start' => [
				...
				'stretch' => [
					'title' => esc_html__('Stretch', 'rometheme-for-elementor'),
		...
		$this->add_responsive_control('title_alignment', [
			'label' => esc_html__('Align Title', 'rometheme-for-elementor'),
			'type' => Controls_Manager::CHOOSE,
			'options' => [
				'start' => [
					'title' => esc_html__('Start', 'rometheme-for-elementor'),
		...
		$this->start_controls_section('section_tabs_responsive', [
			'label' => esc_html__('Additional Settings', 'rometheme-for-elementor'),
		]);

		$this->add_responsive_control(
			'horizontal_scroll',
			[
				'label' => esc_html__('Horizontal Scroll', 'rometheme-for-elementor'),
				'type' => Controls_Manager::SELECT,
				'description' => esc_html__('Note: Scroll tabs if they don’t fit into their parent container.', 'rometheme-for-elementor'),
				'options' => [
					'disable' => esc_html__('Disable', 'rometheme-for-elementor'),
					'enable' => esc_html__('Enable', 'rometheme-for-elementor'),
				],
				'default' => 'disable',
				'selectors_dictionary' => [
		...
		foreach (Plugin::$instance->breakpoints->get_active_breakpoints() as $breakpoint_key => $breakpoint_instance) {
			...
			$dropdown_options[$breakpoint_key] = sprintf(
				...
				esc_html__('%1$s (%2$s %3$dpx)', 'rometheme-for-elementor'),
		...
		$this->add_control(
			'breakpoint_selector',
			[
				'label' => esc_html__('Breakpoint', 'rometheme-for-elementor'),
				'type' => Controls_Manager::SELECT,
				'description' => esc_html__('Note: Choose at which breakpoint tabs will automatically switch to a vertical (“accordion”) layout.', 'rometheme-for-elementor'),
		...
		$this->add_responsive_control('tabs_title_space_between', [
			'label' => esc_html__('Gap between tabs', 'rometheme-for-elementor'),
			'type' => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control('tabs_title_spacing', [
			'label' => esc_html__('Distance from content', 'rometheme-for-elementor'),
			'type' => Controls_Manager::SLIDER,
			'size_units' => ['px', 'em', 'rem', 'custom'],
			'range' => [
				'px' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Transition Duration', 'rometheme-for-elementor') . ' (s)',
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->start_controls_section('section_title_style', [
			'label' => esc_html__('Titles', 'rometheme-for-elementor'),
			'tab' => Controls_Manager::TAB_STYLE,
		]);
...
?>
	...
	protected function render()
	{
		...
		$this->add_render_attribute('elementor-tabs', [
			...
			'aria-label' => esc_html__('Tabs. Open items with Enter or Space, close with Escape and navigate using the Arrow keys.', 'rometheme-for-elementor'),
		]);
	...
	protected function content_template()
	{
		?>
			<# const elementUid=view.getIDInt().toString(); #>
				<div class="e-n-tabs" data-widget-number="{{ elementUid }}" aria-label="<?php echo esc_html__('Tabs. Open items with Enter or Space, close with Escape and navigate using the Arrow keys.', 'rometheme-for-elementor'); ?>">
					<# if ( settings['tabs'] ) { #>
						<div class="e-n-tabs-heading" role="tablist">
		...
		private function content_template_single_item($tab_index, $item, $element_uid, $hover_animation_class)
		{
			?>
				<#
					...
					view.addRenderAttribute( 'tab-title' , { 'id' : tabId, 'class' : [ 'e-n-tab-title' ,escapedHoverAnimationClass ], 'data-tab-index' : tabCount, 'role' : 'tab' , 'aria-selected' : 1===tabCount ? 'true' : 'false' , 'tabindex' : 1===tabCount ? '0' : '-1' , 'aria-controls' : 'e-n-tab-content-' + tabUid, 'style' : '--n-tabs-title-order: ' + tabCount + ';' ,
					}, null, true );

					view.addRenderAttribute( 'tab-title-text' , { 'class' : [ 'e-n-tab-title-text' ], 'data-binding-type' : 'repeater-item' , 'data-binding-repeater-name' : 'tabs' , 'data-binding-setting' : [ 'tab_title' , 'element_id' ], 'data-binding-index' : tabCount, 'data-binding-config' : JSON.stringify({ 'element_id' : {
					attr: 'id' ,
					selector: 'button' ,
					editType: 'attribute' ,
					}, 'tab_title' : {
					...
					view.addRenderAttribute( 'tab-icon' , { 'class' : [ 'e-n-tab-icon' ], 'data-binding-type' : 'repeater-item' , 'data-binding-repeater-name' : 'tabs' , 'data-binding-index' : tabCount,
					}, null, true );
					#>
