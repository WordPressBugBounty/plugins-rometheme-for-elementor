...
class Blockquote extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('blockquote');
    }
    ...
    {
        return ['rtmkit-element-blockquote'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rkit-blockquote .rkit-blockquote-text',
            ]
        );
...
?>
        ...
        <div class="rkit-blockquote <?php echo esc_attr('blockquote-' . $settings['select_layout']) ?>">
            ...
            switch ($settings['select_layout']) {
                case 'inline':
            ?>
                    <<?php echo esc_html($text_tag) ?> class="rkit-blockquote-text">
                ...
                ?>
                    ...
                    <<?php echo esc_html($text_tag) ?> class="rkit-blockquote-text"><?php echo esc_html($settings['quote_text']) ?></<?php echo esc_html($text_tag) ?>>
                    <span class="rkit-quote-author">
                        <?php echo esc_html($settings['quote_author']) ?>
                    </span>
            <?php
