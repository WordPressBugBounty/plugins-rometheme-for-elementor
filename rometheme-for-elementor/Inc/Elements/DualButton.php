...
class DualButton extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('dualbutton');
    }
    ...
    {
        return ['rtmkit-element-dual_button'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'middle_button_effect',
            [
                'label' => esc_html__('Effect', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => esc_html__('None', 'rometheme-for-elementor'),
                    'ripple-effect' => esc_html__('Ripple', 'rometheme-for-elementor'),
                    'pulse-effect' => esc_html__('Pulse', 'rometheme-for-elementor'),
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .dual-left::before',
            ]
        );
        ...
        $this->add_control(
            'button_1_border_radius_divider',
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .left_button, {{WRAPPER}} .dual-left, {{WRAPPER}} .dual-left::before' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'layout_db' => 'row'
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .dual-right::before',
            ]
        );
        ...
        $this->add_control(
            'button_2_border_radius_divider',
            [
                'type' => \Elementor\Controls_Manager::DIVIDER,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .right_button, {{WRAPPER}} .dual-right, {{WRAPPER}} .dual-right::before' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
                'condition' => [
                    'layout_db' => 'row'
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .middle-button.ripple-effect' => 'width: calc( 5px + {{SIZE}}{{UNIT}}); height: calc(5px + {{SIZE}}{{UNIT}});'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .middle, {{WRAPPER}} .middle-button.ripple-effect, {{WRAPPER}} .middle-button.ripple-effect:before, {{WRAPPER}} .middle-button.ripple-effect:after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'btn_box_shadow_normal_middle',
                'selector' => '{{WRAPPER}} .middle',
            ]
        );

        $this->add_control(
            'separator_more_option',
            [
                'label' => esc_html__('Effect', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'middle_button_effect' => ['ripple-effect', 'pulse-effect']
                ]
            ]
        );

        $this->add_control('ripple_color', [
            'label' => esc_html('Ripple Color'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .ripple-effect, {{WRAPPER}} .ripple-effect:before, {{WRAPPER}} .ripple-effect:after' => 'background-color : {{VALUE}}'
            ],
            'condition' => [
                'middle_button_effect' => 'ripple-effect'
            ]
        ]);

        $this->add_control(
            'ripple_delay_animation',
            [
                'label' => esc_html__('Delay Time', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['s'],
                'range' => [
                    's' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ripple-effect, {{WRAPPER}} .pulse-effect' => '--default-delay-time: {{SIZE}}{{UNIT}}'
                ],
                'condition' => [
                    'middle_button_effect' => ['ripple-effect', 'pulse-effect']
                ]
...
?>
        ...
        <div class="dual-button-outer-wrapper">
            <div class="dual-button-inner-wrapper">
