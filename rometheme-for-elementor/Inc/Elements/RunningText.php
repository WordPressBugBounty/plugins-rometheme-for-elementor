...
class RunningText extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('runningtext');
    }
    ...
    {
        return ['rtmkit-element-running_text'];
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            'individual_color_enable',
            [
                'label' => esc_html__('Enable Individual Color', 'rometheme-for-elementor'),
        ...
        $repeater->add_control(
            'item_individual_color',
            [
                'label' => esc_html__('Color', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .rkit-running-text__text' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} {{CURRENT_ITEM}} .rkit-running-text__icon' => 'color: {{VALUE}} ; fill : {{VALUE}};',
                ],
                'condition' => [
                    'individual_color_enable' => 'yes'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'container_layout!' => 'vertical-direction'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'normal' => [
                        'title' => esc_html__('Up', 'rometheme-for-elementor'),
                        'icon' => 'eicon-arrow-up',
                    ],
                    'reverse' => [
                        'title' => esc_html__('Down', 'rometheme-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rkit-marquee-container' => 'align-items: {{VALUE}};'
                ],
                'condition' => [
                    'container_layout' => 'vertical-direction'
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rkit-text-marquee.vertical-direction' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'container_layout' => 'vertical-direction'
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rkit-text-marquee.vertical-direction' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'container_layout' => 'vertical-direction'
                ]
        ...
        $this->add_control(
            'container_padding_color_enable',
            [
                'label' => esc_html__('Enable Edge Fading', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'rometheme-for-elementor'),
                'label_off' => esc_html__('No', 'rometheme-for-elementor'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'running_fading_color',
            [
                'label' => esc_html__('Fading Color', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rkit-text-marquee' => '--rkit-marquee-fade-color: {{VALUE}};',
                ],
                'condition' => [
                    'container_padding_color_enable' => 'yes'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rkit-text-marquee' => '--rkit-marquee-fade-size : {{SIZE}}{{UNIT}}; --rkit-marquee-fading-width: calc(({{SIZE}} / 100) * 10%);',
                ],
                'condition' => [
                    'container_padding_color_enable' => 'yes'
                ]
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'running_text_color_hover',
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .rkit-marquee-item-content:hover .rkit-running-text__text',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html('Color')
                    ]
        ...
        $this->add_control(
            'running_icon_color_hover',
            [
                'label' => esc_html__('Color', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rkit-marquee-item-content:hover .rkit-running-text__icon' => 'color: {{VALUE}} ; fill : {{VALUE}};',
                ],
            ]
        );
...
?>
        ...
        <div class="rkit-text-marquee <?php echo esc_attr($settings['container_layout']) ?>">
