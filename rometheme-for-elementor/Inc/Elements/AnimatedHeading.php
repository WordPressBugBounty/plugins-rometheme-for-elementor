...
class AnimatedHeading extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('animatedheading');
    }
    ...
    {
        return ['rtmkit-element-animated_heading'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rkit-animated-heading-text',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rkit-animated-heading-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rkit-animated-heading__text , {{WRAPPER}} .rkit-animated-heading__text p',
            ]
        );
        ...
        $this->add_control('text_cursor_color', [
            'type' => \Elementor\Controls_Manager::COLOR,
            'label' => esc_html('Text Cursor Color'),
            'selectors' => [
                '{{WRAPPER}} .text-writing::after' => 'color : {{VALUE}}'
            ],
            'condition' => [
                'animation_select' => 'text-writing'
            ]
        ]);
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .rkit-animated-heading__text , {{WRAPPER}} .rkit-animated-heading__text p' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $newString = preg_replace_callback(
            ...
            function ($matches) use ($settings, $svg) {
                if (!empty($matches[1])) {
                    ...
                    return "<span class='rkit-animated-heading-text-wrapper " . esc_attr($css) . "' data-type='" . esc_attr($dataAttribute) . "'><p class='rkit-animated-heading__text'>" . $svg . "</p></span>";
                } elseif (!empty($matches[2])) {
                    return sprintf("<span class='rkit-animated-heading-text'>%s</span>", esc_html($matches[2]));
                } else {
                    return "";
                }
            },
