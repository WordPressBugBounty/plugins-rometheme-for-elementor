...
class SocialShare extends \Elementor\Widget_Base
{
    private function get_widget_data()
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('socialshare');
    }
    ...
    {
        return ['rtmkit-element-social_share'];
    }
