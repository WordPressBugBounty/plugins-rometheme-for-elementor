...
class BarChart extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('barchart');
    }
    ...
    {
        return ['rtmkit-element-bar_chart', 'rtmkit-lib-chart.min'];
    }

    public function get_style_depends()
    {
        return ['rtmkit-element-barchart'];
    }
    ...
    protected function render()
    {
        ...
        $datasets = [
            ...
            'data' => $value,
            'backgroundColor' => $this->get_color_code($settings, 'bar_bg_normal'),
            'borderColor' => $this->get_color_code($settings, 'bar_border_normal'),
            'borderWidth' => $settings['border_width_normal']['size'],
            'hoverBackgroundColor' => $this->get_color_code($settings, 'bar_bg_hover'),
            'hoverBorderColor' => $this->get_color_code($settings, 'bar_border_hover'),
