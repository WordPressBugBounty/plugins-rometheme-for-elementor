...
class ImageBox extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('imagebox');
    }
    ...
    {
        return ['rtmkit-element-image_box'];
    }
    protected function register_controls()
    {
        ...
        $this->start_controls_tab('wrapper_tab_normal', ['label' => esc_html('Normal')]);
        ...
        $this->start_controls_tab('wrapper_tab_hover', ['label' => esc_html('Hover')]);

        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),

            [
                'name' => 'cont_backgroud_wrapper_hover',
                'label' => esc_html__('Container Background', 'rometheme-for-elementor'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .rkit-image_box:hover .rkit-image_box-card'
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => 'containe_imagebox_border_hover',
                'label' => esc_html__('Border  ', 'rometheme-for-elementor'),
                'selector' => '{{WRAPPER}} .rkit-image_box:hover .rkit-image_box-card',
                'condition' => [
                    'select_style!' => 'float-card',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .rkit-image_box__img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control('image_hover_animation' , [
            'label' => esc_html('Hover Animation'),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                '' => esc_html('None'),
                'zoom-in' => esc_html('Zoom In'),
                'zoom-out' => esc_html('Zoom Out'),
                'slide-up' => esc_html('Slide Up'),
                'slide-down' => esc_html('Slide Down'),
                'slide-left' => esc_html('Slide Left'),
                'slide-right' => esc_html('Slide Right'),
            ],
            'default' => 'zoom-in',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => ['classic', 'gradient'],
                'exclude' => ['image'],
                'selector' => '{{WRAPPER}}  .rkit-image_box__img::after ',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rkit-image_box__img::after' => 'opacity:  {{SIZE}}{{UNIT}}',
                ],
                'condition' => [
                    'select_style' => 'overlay',
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .rkit-image_box__title' => 'margin-top: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control('title_color_hover', [
            'label' => esc_html__('Color', 'rometheme-for-elementor'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rkit-image_box:hover .rkit-image_box__title' => 'color : {{VALUE}}'
            ],
        ]);
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .image-box-item-desc ' => 'margin-top: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_tab('description_tab_normal', ['label' => esc_html('Normal')]);
        ...
        $this->start_controls_tab('description_tab_hover', ['label' => esc_html('Hover')]);

        $this->add_control('desc_color_hover', [
            'label' => esc_html__('Color', 'rometheme-for-elementor'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rkit-image_box:hover .rkit-image_box__description' => 'color : {{VALUE}}'
            ],
        ]);
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'desc_cont_backgroud_hover',
                'label' => esc_html__('Background', 'rometheme-for-elementor'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .rkit-image_box:hover .rkit-image_box__detail',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html('Background Color')
                    ]
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'defdesc_cont_backgroud_def_hover',
                'label' => esc_html__('Background', 'rometheme-for-elementor'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .rkit-image_box:hover .float-detail ',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html('Background Color')
                    ]
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'desc_container_box_shadow_hover',
                'label' => __('Box Shadow', 'rometheme-for-elementor'),
                'selector' => '{{WRAPPER}} .rkit-image_box:hover .float-detail ',
                'condition' => [
                    'select_style' => 'float-card',
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'defdesc_cont_backgroud_float_hover',
                'label' => esc_html__('Background', 'rometheme-for-elementor'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .rkit-image_box:hover .def-detail ',
                'condition' => [
                    'select_style' => 'def-card',
                ]
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'defdesc_container_box_shadow_hover',
                'label' => __('Box Shadow', 'rometheme-for-elementor'),
                'selector' => '{{WRAPPER}} .rkit-image_box:hover .def-detail ',
                'condition' => [
                    'select_style' => 'def-card',
        ...
        $this->add_control(
            'icon_desc_color_hover',
            [
                'label' => esc_html__('Color', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#000000FF',
                'selectors' => [
                    '{{WRAPPER}} .rkit-image_box:hover .rkit-icon-top' => ' color: {{VALUE}}; fill: {{VALUE}};',
                ],
                'condition' => [
                    'show_icon_container_top' => 'yes'
                ]
    ...
    protected function render()
    {
        ...
        if ($settings['select_style'] == 'overlay') {
            $flex = "rkit-direction";
            $background = "rkit-image_box__img::after";
        } else {
            $flex = "";
            $background = "";
        }
