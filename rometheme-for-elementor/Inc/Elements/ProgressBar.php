...
class ProgressBar extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('progressbar');
    }
    ...
    {
        return ['progress', 'bar', 'circle', 'line', 'half', 'inline', 'percentage'];
    }
    public function get_style_depends()
    {
        return ['rtmkit-element-progress-bar'];
    }

    public function get_script_depends()
    {
        return ['rtmkit-element-progress'];
    }
