...
class BackToTop extends \Elementor\Widget_Base
{
    private function get_widget_data()
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('backtotop');
    }
    ...
    {
        return ['rtmkit-element-back_to_top'];
    }
