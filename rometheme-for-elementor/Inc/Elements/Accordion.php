...
class Accordion extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('accordion');
    }
                    ...
                    <div class="rkit-accordion-header">
                        <?php if (!empty($settings['show_heading_icons'])) { ?>
                            <div class="rkit-left-header-icon">
                                <?php \Elementor\Icons_Manager::render_icon($item['accordion_header_icon'], ['aria-hidden' => 'true', 'class' => 'accordion_header_icon']); ?>
                            </div>
                        <?php } ?>
