...
class Countdown extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('countdown');
    }
    ...
    {
        return ['rtmkit-element-countdown'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('countdown_style', [
            'label' => esc_html('Style Mode'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'column',
                'selectors' => [
                    '{{WRAPPER}} .countdown-section, {{WRAPPER}} .flip-clock__piece' => 'flex-direction: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'time_text_stroke',
                'label' => esc_html__('Text Stroke', 'rometheme-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .countdown-days, {{WRAPPER}} .countdown-hours, {{WRAPPER}} .countdown-minutes, {{WRAPPER}} .countdown-seconds, {{WRAPPER}} .flip-clock__card.card' => 'color: {{VALUE}}; --card-bottom-b-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'background_time_flip',
            [
                'label' => esc_html__('Background Color', 'rometheme-for-elementor'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .flip-clock__card .card__top, {{WRAPPER}} .flip-clock__card .card__bottom, {{WRAPPER}} .flip-clock__card .card__back::before, {{WRAPPER}} .flip-clock__card .card__back::after' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .countdown_contain, {{WRAPPER}} .countdown-section-container' => 'gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .countdown-section, {{WRAPPER}} .flip-clock__piece' => 'gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        <div class="count">
            <div class="rkit-countdown-widget">
                ...
                <div id="countdown" class="countdown_contain" data-date="<?php echo esc_attr($date); ?>"
                    data-skin="<?php echo esc_attr($settings['countdown_style']) ?>">
                    <?php if ('yes' == $settings['show_days']): ?>
                        <?php if ('flip' == $settings['countdown_style']): ?>
                            <span class="flip-clock__piece" data-label="Days" data-key="days" data-value="00">
                                <b class="flip-clock__card card">
                                    <b class="card__top" data-value="00">00</b>
                    ...
                    <?php if ('yes' == $settings['show_hours']): ?>
                        <?php if ('flip' == $settings['countdown_style']): ?>
                            <span class="flip-clock__piece" data-label="Hours" data-key="hours" data-value="00">
                                <b class="flip-clock__card card">
                                    <b class="card__top" data-value="00">00</b>
                                    <b class="card__bottom" data-value="00"></b>
                                    <b class="card__back"><b class="card__bottom" data-value="00"></b></b>
                    ...
                    <?php if ('yes' == $settings['show_minutes']): ?>
                        <?php if ('flip' == $settings['countdown_style']): ?>
                            <span class="flip-clock__piece" data-label="Minutes" data-key="minutes" data-value="00">
                                <b class="flip-clock__card card">
                                    <b class="card__top" data-value="00">00</b>
                                    <b class="card__bottom" data-value="00"></b>
                                    <b class="card__back"><b class="card__bottom" data-value="00"></b></b>
                    ...
                    <?php if ('yes' == $settings['show_seconds']): ?>
                        <?php if ('flip' == $settings['countdown_style']): ?>
                            <span class="flip-clock__piece" data-label="Seconds" data-key="seconds" data-value="00">
                                <b class="flip-clock__card card">
                                    <b class="card__top" data-value="00">00</b>
                                    <b class="card__bottom" data-value="00"></b>
                                    <b class="card__back"><b class="card__bottom" data-value="00"></b></b>
