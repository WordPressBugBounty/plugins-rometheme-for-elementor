...
class Tabs extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('tabs');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('nav_pos_vertical', [
            'label' => esc_html('Navigation Position'),
            'type' => \Elementor\Controls_Manager::CHOOSE,
            'options' => [
                'flex-start' => [
            ...
            'default' => 'flex-start',
            'selectors' => [
                '{{WRAPPER}} .rkit-tab-container.vertical .rkit-tab-nav' => 'align-self: {{VALUE}}'
            ],
            'condition' => [
                'layout' => 'vertical'
            ]
