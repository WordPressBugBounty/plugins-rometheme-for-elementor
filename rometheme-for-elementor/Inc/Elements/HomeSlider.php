...
class HomeSlider extends \Elementor\Widget_Base
{
    ...
    {
        return \RTMkit\Modules\Widgets\WidgetStorage::instance()->get_widget_data_by_key('home_slider');
    }
    ...
    {
        return ['rtmkit-element-home_slider', 'rtmkit-lib-swiper.min'];
    }


    public function get_script_depends()
    {
        return ['rtmkit-element-home_slider', 'rtmkit-lib-swiper-bundle.min'];
    }
