...
class BlurEffects
{
	...
	{
		wp_enqueue_style(
			'rkit-blur-effect-style',
			RTM_KIT_URL . 'Inc/Extensions/assets/css/BlurEffects.css',
			[],
			\RTM_KIT_VERSION
		);
	}
	...
	public function add_container_options($container, $args)
	{
		...
		$container->start_controls_section('rtmkit_blur_effects_container', [
			'label' => \RTMKit\Modules\Extensions\ExtensionStorage::get_logo() . esc_html('Glass Effect'),
