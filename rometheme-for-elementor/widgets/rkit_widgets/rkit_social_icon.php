...
class Rkit_Social_Icon extends \Elementor\Widget_Base
{
    public function get_name()
    {
        return 'rtm-social_icon';
    }

    public function get_title()
    {
        return \RomethemeKit\RkitWidgets::listWidgets()['social_icon']['name'];
    }

    public function get_icon()
    {
        $icon = 'rkit-widget-icon ' . \RomethemeKit\RkitWidgets::listWidgets()['social_icon']['icon'];
        return $icon;
    }

    public function get_keywords()
    {
        return ['social', 'rtm', 'icons', 'social icons'];
    }
