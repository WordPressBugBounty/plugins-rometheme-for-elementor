        ...
        <div class="row row-cols-xl-2 row-cols-1 rtm-text-font px-4 pt-5">
            <div class="col col-lg-7">
                <div class="d-flex flex-column gap-4 pe-lg-5 px-4">
                    ...
                    <div class="rtm-divider w-50"></div>
                    <span class="accent-color">Everything you need in one place</span>
                    <h1 class="text-white">
                        The Ultimate Elementor<br /> Addons for WordPress<br /> Website
                    </h1>
                    <div class="d-flex flex-row align-items-center gap-4">
                        <a href="https://www.youtube.com/@Rometheme_Studio" target="_blank" class="btn btn-gradient-accent rounded-pill text-nowrap">Watch Video <i class="rtmicon rtmicon-arrow-up-right ms-2"></i></a>
                        <a href="https://support.rometheme.net/docs/romethemekit/widgets/" target="_blank" class="btn btn-outline-light rounded-pill text-nowrap">Documentation <i class="rtmicon rtmicon-arrow-up-right ms-2"></i></a>
                    </div>
                </div>
            </div>
...
<div class="rtm-container me-3 d-flex flex-column gap-3">
    <div class="d-flex flex-lg-row flex-column gap-3">
        <div class="col">
            <div class="rtm-bg-gradient-1 p-5 rounded-3 d-flex flex-column gap-4 h-100">
                <div class="d-flex flex-row align-items-center gap-3">
                    <div class="bg-gradient-2 heading-icon">
                        <i class="fa-brands fa-youtube"></i>
                    </div>
                    <h4 class="text-nowrap m-0 text-white">Watch Our Tutorial Video Here</h4>
                    <div class="col">
                        <div class="rtm-divider"></div>
                    </div>
                </div>
                <span class="rtm-text-font text-gray">Learn how to build the website with high efficiency and faster way.</span>
                <div class="d-flex flex-row gap-4">
                    <div class="col">
                        <div class="yt-container overflow-hidden rounded-3">
                            <div class="thumbnail">
                                <img src="https://i1.ytimg.com/vi/z27RYQVGaYE/maxresdefault.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="overlay">
                                <a href="https://youtu.be/z27RYQVGaYE?feature=shared" target="_blank">
                    ...
                    <div class="col">
                        <div class="yt-container overflow-hidden rounded-3">
                            <div class="thumbnail">
                                <img src="https://i1.ytimg.com/vi/-WAhHxMxtmw/maxresdefault.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="overlay">
                                <a href="https://youtu.be/-WAhHxMxtmw?feature=shared" target="_blank">
                                    <i class="fa-solid fa-circle-play"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="d-flex flex-row align-items-center gap-4">
                    <a href="https://www.youtube.com/playlist?list=PLiDcdRZHQZ66vm5sZ6maMY-CZiZuweCRo" target="_blank" class="btn btn-gradient-accent rounded-pill">Watch Tutorial <i class="rtmicon rtmicon-arrow-up-right ms-2"></i></a>
